...
var
    ...
    _organizeTracks = function(type, locations, categoryViewer) {
        ...
        if (trackShapes.length !== 0) {//shapes
            ...
            if (categoryViewer._categoryContains(FTVUtils.getFTLocation().bridge)) {
...
NonOverlappingProteinCategoryFTViewer.paintFeatures = function(categoryViewer) {
    ...
    _.each(types, function(type) {
        ...
        if (type.numberTracks !== 1) {
            ...
            height = categoryViewer._calculateAdjustHeight(categoryViewer, height, false);
            categoryViewer._applyHeight(categoryViewer, height, 2);
        }
