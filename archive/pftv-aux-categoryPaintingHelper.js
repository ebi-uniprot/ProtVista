 ...
 * @returns {*}
 */
CategoryPaintingHelper.getTypes = function(categoryViewer) {
    var style = categoryViewer._styleView.toLowerCase();
    if (style === FTVUtils.styleViews.variants) {
        return VariantProteinCategoryFTViewer.getTypes(categoryViewer);
    } else {
