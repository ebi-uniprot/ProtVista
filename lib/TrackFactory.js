...
var Track = function(typeFeatures, container, xScale, zoom, selectedFeature) {	
	var track = this;
	...
	track.xScale = xScale;
	track.zoom = zoom;
	track.selectedFeature = selectedFeature;
...
Track.basic = function() {
	this.trackViewer = new BasicTrackViewer(this.data, this.trackContainer, this.xScale, this.zoom, this.selectedFeature);
};

var BasicTrackViewer = function(features, container, xScale, zoom, selectedFeature) {
...
var TrackFactory = function() {
	return {
		createTrack: function(typeFeatures, type, container, xScale, zoom, selectedFeature) {
			...
			Track[type].prototype = new Track(typeFeatures, container, xScale, zoom, selectedFeature);
