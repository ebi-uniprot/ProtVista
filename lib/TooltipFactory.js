...
var parseVariantDescription = function(data) {
    if (data.description) {
        ...
        data.ftId = descriptionArray['Ftid'].toString().replace(/Ftid:/g, '');
        data.up_description = descriptionArray['UP'].toString();
        data.lss_description = descriptionArray['LSS'].toString().replace(/LSS:/g, '');
    }
