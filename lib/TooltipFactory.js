...
var Tooltip = function(fv, d, container) {
    ...
    tooltip.automatic = ['ECO:0000256', 'ECO:0000213', 'ECO:0000313'];
...
var VariantTooltipViewer = function(tooltip) {
    ...
    if (tooltip.data.sp && (isSift || isPolyphen)) {
        ...
        _.each(tooltip.data.evidences, function(e) {
            _.contains(tooltip.manual, e.code) ? upEvidences.push(e) : lssEvidences.push(e);
        });
