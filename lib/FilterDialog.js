...
var FilterDialog = function() {
    var onClick = function(fv) {
        ...
        fv.applyFilter({
            isManual: d3.select('#up_pftv_dialog-checkReviewed').property('checked')
            , isAutomatic: d3.select('#up_pftv_dialog-checkOther').property('checked')
            , disease: d3.select('#up_pftv_dialog-checkDisease').property('checked')
            , notDisease: d3.select('#up_pftv_dialog-checkNotDisease').property('checked')
        });
    };
