...
Feature.wave = function(width, height, length) {
	...
	var shape = 'M' + (-symbolSize/2+gapShape) + ',' + (symbolSize/3)
		    + "A" + r + "," + r + " 0 1,1 " + gapShape + "," + symbolSize/3
		    + "A" + r + "," + r + " 0 1,0 " + (symbolSize/2+gapShape) + ',' + symbolSize/3;
    return length !== 1 
		? shape + getMiddleLine(symbolSize/3, width) + 'Z'
		: shape + 'Z';
};
