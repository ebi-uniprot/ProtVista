    ...
    _.each(types, function(type) {
        ...
        if (type.numberTracks !== 1) {
            ...
            var titleHeight = FTVUtils.getTrackMode(categoryViewer.opt.category) === "category"
                ? FTVUtils.calculateTextHeightDIV(FTVUtils.getTrackTitle(categoryViewer.opt.category), "categoryTitle", FTVUtils.getTitlesWidth(false))
                : FTVUtils.calculateTextHeightDIV(FTVUtils.getTrackTitle(categoryViewer.opt.category), "categoryTitleNoCollapsible", FTVUtils.getTitlesWidth(false));
            ...
            var innerDivCategory = d3.select("#" + categoryViewer.opt.target + " div.category")
                .style("height", (height+4) + "px"); //+4
            innerDivCategory.selectAll("div").style("height", (height+2-FTVUtils.getTitlesPadding()*2) + "px");
            innerDivCategory.selectAll("div.categoryFeatures").style("height", (height+2) + "px");
