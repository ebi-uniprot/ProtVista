...
var FeaturesViewer = function(opts) {
	...
	var init = function(d) {
		...
		addCategory(CategoryFactory.createCategory(d.domainsAndSites, 'basic', container, xScale, width, fv.zoom, fv.selectedFeature));
		addCategory(CategoryFactory.createCategory(d.moleculeProcessing, 'basic', container, xScale, width, fv.zoom, fv.selectedFeature));
		addCategory(CategoryFactory.createCategory(d.ptm, 'basic', container, xScale, width, fv.zoom, fv.selectedFeature));
		addCategory(CategoryFactory.createCategory(d.seqInfo, 'basic', container, xScale, width, fv.zoom, fv.selectedFeature));
		addCategory(CategoryFactory.createCategory(d.structural, 'basic', container, xScale, width, fv.zoom, fv.selectedFeature));
		addCategory(CategoryFactory.createCategory(d.topology, 'basic', container, xScale, width, fv.zoom, fv.selectedFeature));
		addCategory(CategoryFactory.createCategory(d.mutagenesis, 'basic', container, xScale, width, fv.zoom, fv.selectedFeature));
		addCategory(CategoryFactory.createCategory(d.variants, 'variant', container, xScale, width, fv.zoom, fv.selectedFeature));
