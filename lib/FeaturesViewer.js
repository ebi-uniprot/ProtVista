...
var FeaturesViewer = function(opts) {
    ...
    var createButtons = function(container) {
        ...
        buttons.append('span')
            ...
            .attr('title','Variants filter')
            .on('click', function(){
                FilterDialog.displayDialog(buttons, fv);
            });
        buttons.append('span')
    ...
    var init = function(d) {
        ...
        fv.aaViewer2 = createAAViewer(bottomAAViewerContainer, d.sequence);
        updateViewportFromChart();
        updateZoomFromChart();
    };
