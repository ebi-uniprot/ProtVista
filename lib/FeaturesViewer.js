...
var FeaturesViewer = function(opts) {
	...
	fv.dispatcher = d3.dispatch("featureSelected");
    fv.width = 760;
	fv.maxZoomSize = 30;
	...
	var createNavRuler = function(container) {
        ...
        viewport.updateTrapezoid = function() {
            var begin = d3.select(".extent").attr("x");
            var tWidth = d3.select(".extent").attr("width");
