...
var createButtons = function(fv, categories, data, container) {
...
var init = function(fv, categories, filterCategories, opts, d, padding) {
    ...
    createButtons(fv, categories, d, fvContainer);
    ...
    _.each(fv.categoryOrderAndType, function(value, category) {
        if (!_.contains(opts.exclusions, category)) {
            if (d[category].features.length !== 0) {
...
var FeaturesViewer = function(opts) {
    ...
    fv.applyFilter = function() {
        ...
        if (fv.selectedFeature && _.contains(fv.filterTypes, fv.selectedFeature.type.name)) {
            if ( !VariantFilterDialog.displayFeature(fv.selectedFeature) ) {
                ViewerFactory.selectFeature(fv.selectedFeature, fv.selectedFeatureElement, fv);
            }
        }
    };
