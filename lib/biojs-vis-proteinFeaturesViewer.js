...
var
    ...
    _initCategories = function(self) {
        ...
        container.append(CategoryFactory.createCategory(features.domainsAndSites,'basic'));
        container.append(CategoryFactory.createCategory(features.moleculeProcessing,'basic'));
        container.append(CategoryFactory.createCategory(features.mutagenesis,'basic'));
        container.append(CategoryFactory.createCategory(features.ptm,'basic'));
        container.append(CategoryFactory.createCategory(features.seqInfo,'basic'));
        container.append(CategoryFactory.createCategory(features.structural,'basic'));
        container.append(CategoryFactory.createCategory(features.topology,'basic'));
        container.append(CategoryFactory.createCategory(features.variants,'variant'));
