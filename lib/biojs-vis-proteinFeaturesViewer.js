...
var
    ...
    _initControls = function(self, controlDivUp) {
        ...
        self._zoomInButton = _initZoomButton(self, leftControlDivUpRight, FTVUtils.ID_CLASS_PREFIX + "zoomInButton", FTVUtils.ID_CLASS_PREFIX + "spriteZoomIn", true);
        self._zoomOutButton = _initZoomButton(self, leftControlDivUpRight, FTVUtils.ID_CLASS_PREFIX + "zoomOutButton", FTVUtils.ID_CLASS_PREFIX + "spriteZoomOut", false);
        self._moveLeftButton = _initMoveButton(self, leftControlDivUpRight, FTVUtils.ID_CLASS_PREFIX + "moveLeftButton", FTVUtils.ID_CLASS_PREFIX + "spriteMoveLeft", "move-left", "Move current display 50% left", true);
        self._moveRightButton = _initMoveButton(self, leftControlDivUpRight, FTVUtils.ID_CLASS_PREFIX + "moveRightButton", FTVUtils.ID_CLASS_PREFIX + "spriteMoveRight", "move-right", "Move current display 50% right", false);

        var rightControlDivUpRight = controlDivUpRight.append("div").classed(FTVUtils.ID_CLASS_PREFIX + "right", true);
        self._openAllButton = _initAllButton(self, rightControlDivUpRight, FTVUtils.ID_CLASS_PREFIX + "openAllButton", FTVUtils.ID_CLASS_PREFIX + "spriteOpenAll", "open-all", true);
        self._closeAllButton = _initAllButton(self, rightControlDivUpRight, FTVUtils.ID_CLASS_PREFIX + "closeAllButton", FTVUtils.ID_CLASS_PREFIX + "spriteCloseAll", "close-all", false);

        self._settingsButton = rightControlDivUpRight.append("div")
            .attr("id", FTVUtils.ID_CLASS_PREFIX + "settingsButton")
            .classed(FTVUtils.ID_CLASS_PREFIX + "clickable " + FTVUtils.ID_CLASS_PREFIX + "spriteSettings " + FTVUtils.ID_CLASS_PREFIX + "nothingOnBodyClick", true)
        ...
        self._helpButton = rightControlDivUpRight.append("div")
            .attr("id", FTVUtils.ID_CLASS_PREFIX + "helpButton")
            .classed(FTVUtils.ID_CLASS_PREFIX + "clickable " + FTVUtils.ID_CLASS_PREFIX + "spriteHelp " + FTVUtils.ID_CLASS_PREFIX + "nothingOnBodyClick", true)
            .style("display",  _BUTTON_DISPLAY)
