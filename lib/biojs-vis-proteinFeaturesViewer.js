...
var
    ...
    _init = function(self) {
        ...
        _initTooltip(self);
        console.log(self.opt.featuresModel);
    ...
    _initIdentifier = function(self, controlDivDown) {
        controlDivDown.append("div")
            ...
            .style("width", FTVUtils.getTitlesWidth() + "px")
            .text(self.opt.featuresModel.accession.toUpperCase());
    },
    /**
    ...
    _initCategories = function(self) {
        var dark = true;
        var features = self.opt.featuresModel;
        var container = $('#' + self.opt.target).append('<div class="fv-category-container"></div>');

        var visualisationWidth = 500;

        container.append(CategoryFactory.createCategory(features.domainsAndSites,'basic', container, visualisationWidth, features.sequence.length));
        container.append(CategoryFactory.createCategory(features.moleculeProcessing,'basic', container, visualisationWidth, features.sequence.length));
        container.append(CategoryFactory.createCategory(features.mutagenesis,'basic', container, visualisationWidth, features.sequence.length));
        container.append(CategoryFactory.createCategory(features.ptm,'basic', container, visualisationWidth, features.sequence.length));
        container.append(CategoryFactory.createCategory(features.seqInfo,'basic', container, visualisationWidth, features.sequence.length));
        container.append(CategoryFactory.createCategory(features.structural,'basic', container, visualisationWidth, features.sequence.length));
        container.append(CategoryFactory.createCategory(features.topology,'basic', container, visualisationWidth, features.sequence.length));
        container.append(CategoryFactory.createCategory(features.variants,'variant', container, visualisationWidth, features.sequence.length));
