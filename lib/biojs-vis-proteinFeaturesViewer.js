    ...
    _constructor = function(self, options) {
        ...
        try {
            ...
            d3.select("#" + targetID).text("Please make sure you are providing a modelFeatures element in the configuration options. " +
                "Please take a look to configuration options and mandatory fields at https://github.com/ebi-uniprot/biojs-vis-proteinFeaturesViewer. " +
                "If you still have problems, you can report the following error to developers via GitHub. Error: " + error);
        }
    },
    ...
    _onInstanceFeatureClick = function(self, obj) {
        ...
        if (self.opt.clickable === true) {
            if ( (obj.feature.selected === true)
                ...
                var category = self.opt.featuresModel.categories[obj.feature.categoryIndex];
                if (category.types) {
                ...
                if (recentlyUnselected != undefined) {
                    ...
                    var category = self.opt.featuresModel.categories[recentlyUnselected.categoryIndex];
                    if (category.types) {
                        category
                        ...
                        category
                            .variants[recentlyUnselected.featureIndex].selected = false;
                    }
