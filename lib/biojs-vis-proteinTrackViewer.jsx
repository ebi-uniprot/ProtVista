...
var biojs_vis_proteinTrackViewer;

module.exports = biojs_vis_proteinTrackViewer = function(options){
...
var
    ...
    _constructor = function(self, options) {
        ...
        component.on('openClose', function(obj) {
...
biojs_vis_proteinTrackViewer.prototype.myVar = "i am a variable";
biojs_vis_proteinTrackViewer.prototype.test = function test(anything) {
