...
var VariantCategoryViewer = function(category) {
    ...
    var totalVariantCount = _.reduce(variationCountArray, function(memo, num) {
        return memo + num;
    }, 0);
    ...
    this.update = function() {
        var countArray = category.fv.manual && category.fv.automatic ? variationCountArray
            : category.fv.manual && !category.fv.automatic ? manualVariationCountArray
            : !category.fv.manual && category.fv.automatic ? automaticVariationCountArray
