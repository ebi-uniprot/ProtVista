...
var Category = function(data, container, xScale, width, zoom) {
	...
	category.toggle = function() {
		if (!category.tracksCreated) {
			category.tracksCreated = true;
			...
			selection.each(function(data) {
				...
				shapes
					...
					.on('click', function(d,i){
						...
						d3.selectAll('.up_pftv_activeFeature').classed('up_pftv_activeFeature', false);	//should we avoid this selectAll loop?
