...
Category.basic = function() {
	this.categoryViewer = new BasicCategoryViewer(this.data.features, this.viewerContainer, this.xScale, this.width, this.zoom, this.options, this);
};

Category.variant = function() {
	this.categoryViewer = new VariantCategoryViewer(this.data.features, this.viewerContainer, this.xScale, this.width, this.zoom, this.options, this);
};
...
//Viewer types
var BasicCategoryViewer = function(features, container, xScale, width, zoom, options, category) {
