...
var variantsFill = function(d, fv) {
    ...
    } else if((d.sourceType === Evidence.variantSourceType.uniprot) || (d.sourceType === Evidence.variantSourceType.mixed)) {
        if (d.association) {
...
var drawVariants = function(variantViewer, bars, frequency, fv, container, catTitle) {
    ...
    variantCircle
        ...
        .classed('up_pftv_variant_hidden', function(d) {
            return VariantFilterDialog.displayFeature(d) ? false : true;
        })
        .attr('cx', function(d) {
    ...
    ViewerHelper.addEventsClassAndTitle(catTitle, variantCircle, fv, container);
