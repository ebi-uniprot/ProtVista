...
var createDataSeries = function(svg, features, series, yScale, width, height, margin) {
...
var VariantViewer = function(features, container, fv, width) {
    ...
    var dataSeries = createDataSeries(svg, features, series, yScale, width, height, margin);
