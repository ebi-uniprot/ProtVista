...
var SelectorFactory = require("./SelectorFactory");
...
var VariantViewer = function(features, container, fv, width, clip, effectiveHeight) {
    ...
    var variationPlot = function() {
        ...
        var drawVariants = function(bars) {
            ...
            variantCircle.attr('cx', function(d) {
                ...
                .attr('cy', function(d) {
                    return yScale(d.alternativeSequence);
                })
                .attr('r', function(d) {
                ...
                .attr('class', function(d) {
                    ...
                    SelectorFactory.selectFeature(d, this, fv);
                });
    ...
    var svg = container
        .append('svg')
        .attr('class','variants-svg')
        .attr('width', width)
        .attr('height', height);

    SelectorFactory.createSelectionShadow(svg, height);
    ...
    this.update = function() {
        ...
        if (fv.selectedFeature) {
            SelectorFactory.updateShadow(fv.selectedFeature, fv.selectedFeatureElement, fv);
        }
    };
