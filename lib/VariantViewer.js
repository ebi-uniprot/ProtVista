...
var VariantViewer = function(features, container, fv, width, clip) {
    ...
    var svg = ViewerFactory.createSVG(container, width, height, fv.zoom, 'variants-svg');
    ...
    this.update = function() {
        ...
        if (fv.selectedFeature) {
            ViewerFactory.updateShadow(fv.selectedFeature, fv.selectedFeatureElement, fv);
        }
    };
