...
var BasicViewer = function(features, container, fv, width, height, clip, effectiveHeight) {
    ...
    var shadowG = svg.append('g').append('rect')
        ...
        .attr('x', 0)
        .attr('y', 0)
        .attr('height', effectiveHeight === 0 ? 0 : effectiveHeight - 1)
        .attr('width', 0);
    svg.attr('height', effectiveHeight === 0 ? height : effectiveHeight - 1);
