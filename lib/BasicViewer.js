...
var BasicViewer = function(features, container, fv, width) {
            ...
            selection.each(function(data) {
                ...
                shapes
                    ...
                    .on('click', function(d){
                        ...
                        basicViewer.selectFeature(d, this, fv);
                    });
    ...
    this.updateShadow = function(feature, elem) {
    ...
    this.update = function() {
        ...
        if (fv.selectedFeature) {
            this.updateShadow(fv.selectedFeature, fv.selectedFeatureElement);
        }
    };

    this.selectFeature = function(feature, elem, fv) {
        var selectedElem = d3.select(elem);
        ...
        if (feature === fv.selectedFeature) {
            ...
            this.updateShadow(feature, elem);
        }
...
BasicViewer.selectFeature = function(feature, elem, fv) {
    var selectedElem = d3.select(elem);
    if (feature === fv.selectedFeature) {
        fv.selectedFeature = undefined;
        fv.selectedFeatureElement = undefined;
