...
ViewerHelper.highlightRegion = function(fv) {
    if (!fv.highlightedRegion) {
        return;
    }
    ...
    var xTranslate = fv.xScale(fv.highlightedRegion.begin);
    var aaWidth = fv.xScale(2) - fv.xScale(1);
    var gapRegion = aaWidth/2;
    var width = aaWidth * (fv.highlightedRegion.end - fv.highlightedRegion.begin + 1);
    d3.selectAll('.up_pftv_shadow')
        .attr('d', function() {
    ...
    fv.dispatcher.regionHighlighted(fv.highlightedRegion);
};
