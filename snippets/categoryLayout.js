...
var Track = require("biojs-vis-proteinTrackViewer");
            ...
            "locations": [
                {
                    "locationType": "POSITION",
                    "features": [
                        {"ftId": "non-ter-0", "description": "non-ter-0-desc", "internalId": "internal ID", "begin": sequence.length, "end": sequence.length}
                    ]
                }
            ]
